...
Technical Workflow
Exploratory Data Analysis (EDA): Visualized price distributions and correlations between variables using Seaborn and Matplotlib.

Preprocessing: Handled outliers in the area feature and applied label encoding to categorical variables (Yes/No, Furnishing status).

Modeling: Implemented and compared:

Multiple Linear Regression

Random Forest Regressor

Evaluation: Assessed models using R-squared and Mean Squared Error (MSE) to determine prediction accuracy.
